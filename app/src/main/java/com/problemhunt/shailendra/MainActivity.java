...
public class MainActivity extends AppCompatActivity implements AboutView {

    private SwipeRefreshLayout srlRefresh;
    private AboutCountryAdapter adapter;
    private ArrayList<AboutModel> factsModels;
    private String screenTitle;
    private AboutPresenter factPresenter;
    ...
    private void initViews(Bundle savedInstanceState) {
        ...
        adapter = new AboutCountryAdapter(factsModels, this);
        ...
        factPresenter = new AboutPresenterImpl(this, new AboutInteractorImpl());
     ...
     */
    @Override
    public void loadRecyclerView(ArrayList<AboutModel> factsModel) {
